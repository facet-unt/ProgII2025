...
//        /*CREAR PRODUCTO*/
        ...
        System.out.println(gp.crearProducto(2, "Bife con arroz", 2.0f, Categoria.PLATOPRINCIPAL, Estado.DISPONIBLE));
        ...
        System.out.println(gp.crearProducto(7, "Suprema con pure", 3.0f, Categoria.PLATOPRINCIPAL, Estado.DISPONIBLE));
        System.out.println(gp.crearProducto(9, "Suprema con ensalada", 2.8f, Categoria.PLATOPRINCIPAL, Estado.DISPONIBLE));
