...
public class VentanaAMEncargado extends JDialog {
    ...
    private void btnGuardarClic(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarClic
        ...
        // Validación básica
        if (correo.isEmpty() || apellido.isEmpty() || nombre.isEmpty() || clave.isEmpty()) {
        ...
        // Crear el encargado
        Encargado nuevoEncargado = new Encargado(correo, apellido, nombre, clave);

        // Guardar en la lista
        encargados.add(nuevoEncargado);

        // Confirmación
        javax.swing.JOptionPane.showMessageDialog(this, "Encargado guardado correctamente.", "Éxito", javax.swing.JOptionPane.INFORMATION_MESSAGE);
