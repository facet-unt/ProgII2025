...
public class VentanaAMEmpleado extends JDialog {
    ...
    private void btnGuardarClic(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarClic
        ...
        // Crear el empleado
        Empleado nuevoEmpleado = new Empleado(correo, apellido, nombre, clave);

        // Guardar en la lista
        empleado.add(nuevoEmpleado);

        // Confirmación
        javax.swing.JOptionPane.showMessageDialog(this, "Empleado guardado correctamente.", "Éxito", javax.swing.JOptionPane.INFORMATION_MESSAGE);
