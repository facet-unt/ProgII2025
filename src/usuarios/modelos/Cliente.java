...
public class Cliente extends Usuario {
   ...
   @Override /*Redifinicion del metodo verPedidos. Devuelve los pedidos del cliente*/
    ...
    /*AGREGADO DEL METODO realizarReserva()*/
    
    public String realizarReserva(LocalDateTime fechaYHora)
    {
        String apellido;
        apellido = verApellido();
        String cadenaFecha = fechaYHora.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"));
        String cadenaHora = fechaYHora.format(DateTimeFormatter.ofPattern("hh:mm"));
        
        return apellido + " reservo el " + cadenaFecha + " a las " + cadenaHora + " hs";
