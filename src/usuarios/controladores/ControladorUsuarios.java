...
public class ControladorUsuarios implements IControladorUsuarios {
    ...
    public void btnBorrarClic(ActionEvent evt) {
        ...
        try {
            ...
            int opcionSeleccionada = JOptionPane.showOptionDialog(
                    this.ventanaUsuarios,CONFIRMACION,"Advertencia",JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE,null,new Object[]{"Si", "No"},"Si"
            );
    ...
    private void actualizarDatosTabla() {
        AbstractTableModel modeloTablaUsuarios =
                (AbstractTableModel) this.ventanaUsuarios.verTablaUsuarios().getModel();
    ...
    public void btnBuscarClic(ActionEvent evt) {
        ...
        if (apellidoBuscar != null) {
            ...
            AbstractTableModel modeloTablaUsuarios =
                    (AbstractTableModel) this.ventanaUsuarios.verTablaUsuarios().getModel();
            ((ModeloTabla) modeloTablaUsuarios)
                    .actualizarDatosTabla(coincidenciasApellido);
        } else {
            this.actualizarDatosTabla();
        }
    }
